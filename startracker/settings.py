"""
Django settings for startracker project.
...
SECRET_KEY = 'django-insecure-pozh_q^lgue%2i1h@m6jax=2$%u3vi#wd!+waq71rwk(daf%8s'
...
WSGI_APPLICATION = 'startracker.wsgi.application'
